...
const postcss = require('gulp-postcss') //  load the post css library
...
gulp.task('sass', function () {
  ...
  return gulp
    ...
    .pipe(sass()) //  run the sass complier on the source file
    .pipe(gulp.dest('css')) // destination for the complied css files
...
//  initialize browserSync on the current folder
  ...
  // watch for changes on any .html file and reload the broswer on changes
